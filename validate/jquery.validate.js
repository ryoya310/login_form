...
$.validator.format = function( source, params ) {
	...
	if ($(params[1]).hasClass("required2")) {

		source = source.replace( new RegExp( "\\{text\\}", "g" ), function() {
			return ($(params[1]).attr("label")) ? $(params[1]).attr("label") : "この項目";
		} );
...
$.extend( $.validator, {
	...
	messages: {
		...
		required2: $.validator.format( "This {0} is required2." ),
